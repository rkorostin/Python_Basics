...
def parse_text(html_text):
    """
    Функция для обработки HTML-текста: удаление символов и приведение к нижнему регистру.
...
def count_words(text, max_word_length):
    ...
    Возвращает ответ в виде списка кортежей.
...
url = input("Введите URL-адрес (например, https://yandex.ru): ")
max_word_length = int(input("Введите минимальное количество букв в слове: "))
